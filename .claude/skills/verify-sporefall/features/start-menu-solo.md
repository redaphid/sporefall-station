...
- A Lane A profile may already hold a save. Solo run from the picker then resumes it instead of starting fresh. `?seed=N` always starts seed N and leaves the save alone.
