...
**Status: NOT STARTED. Blocked on the ComfyUI custom-node install the owner must approve
(see `_mycel-results/assets.md`). No sprites were generated by this pass — this is the spec
for whoever runs the pipeline next.**
