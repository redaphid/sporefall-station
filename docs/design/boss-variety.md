...
### C5. §4.3's "restore the power" counterplay DOES NOT EXIST
...
### C6. §4.3 is wrong that `fortify` can simply be reused by a boss
...
### C7. Tier composition: `hunt` starves `fortify`
