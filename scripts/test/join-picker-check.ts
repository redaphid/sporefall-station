...
const main = async (): Promise<void> => {
  ...
  await plain.goto(`${BASE}/?mode=join&class=thief&room=picker-check&name=Picky`)
  if (hasBt) {
  ...
  await page.goto(`${BASE}/?mode=join&class=thief&room=picker-check2&name=Picky`)
  ...
  await page3.goto(`${BASE}/?mode=join&class=thief&room=picker-check3&name=Picky&transport=tabs`)
